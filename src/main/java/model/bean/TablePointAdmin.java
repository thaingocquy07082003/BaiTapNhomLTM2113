...
public class TablePointAdmin {
    private String name_room;
    private String username;
    private int mssv;
    private  String  name_student;
    private  double point_student;
    public TablePointAdmin() {
    }
    ...
    public TablePointAdmin(String name_room, String username, int mssv, String name_student, double point_student) {
        this.name_room = name_room;
        this.username = username;
        this.mssv = mssv;
        this.name_student = name_student;
